...
import { formatPostDate, getPost, getPostContent } from "./posts";

function GCSciencePost() {
    ...
    <div className="website">
      ...
      <main className="gcs-post-page">
        ...
        <aside className="gcs-post-side" aria-hidden="true">
          <span className="gcs-post-side-label">GC Science</span>
